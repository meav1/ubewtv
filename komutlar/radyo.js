...
const radio = {
    "metrofm": "https://www.canliradyodinle.fm/number-one-turk-dinle.html#",
    ...
    "efkarlı": "http://www.radyodinle.fm/#best-fm-98-4"
      ...
      if (!args) return msg.channel.send(':x: | Bir Radyo Seçin : **metrofm**, **efkarlı**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')

        if(!radio[args]) return msg.channel.send(':x: | Lütfen Yandaki Radiolardan Birini Seç : **metrofm**, **efkarlı**, **rtl2**, **skyrock**, **rtl**, **rfm**, **bfm**')
