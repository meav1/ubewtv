...
module.exports.run = async (bot, message, args) => {
  ...
  if(!tomute) return message.reply("Bu Komutu Kullanmak İçin : mg!sustur <Kullanıcı> <Süre> Olarak Yazmalısınız.");
...
let muterole = message.guild.roles.find(r => r.name === "Muted");
  ...
  //end of create role
  let mutetime = args[1];
  if(!mutetime) return message.reply("Bu Komutu Kullanmak İçin :  mg!sustur <Kullanıcı> <Süre> Olarak Yazmalısınız.");
